...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=100, help_text='Pon aquí de qué va el libro')
    isbn = models.CharField('ISBN', max_length=13, help_text='EL ISBN de 13 carácteres')
