    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Pon aquí de qué va el libro', max_length=100)),
                ('isbn', models.CharField(help_text='EL ISBN de 13 carácteres', max_length=13, verbose_name='ISBN')),
